...
def get_args():#command option
    ...
    scanned_output = scan(options.target)#get value in the move to the scan function
    display_result(scanned_output)#move to the display_result function
    
  
def scan(ip):#scan the network
...
def display_result(result):#display the result
